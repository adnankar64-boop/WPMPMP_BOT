...
if not BOT_TOKEN:
    raise RuntimeError("Environment variable BOT_TOKEN is not set. Set BOT_TOKEN and restart the bot.")
if not COINGLASS_API_KEY:
    # If you want to allow running without CoinGlass, comment out the next line.
    raise RuntimeError("Environment variable COINGLASS_API_KEY is not set. Set COINGLASS_API_KEY and restart the bot.")
...
def main():
    ...
    logger.info("Starting bot polling (proxy -> %s)", PROXY_URL or "(none)")
